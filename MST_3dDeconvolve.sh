...
3dDeconvolve -input MST_r*_scale.nii                            \
    ...
    -jobs 3                                      \
    -num_glt 3                                  \
    -gltsym 'SYM: +1*MST_novel[5..6]'          \
    -glt_label 1 'MST_novel'                  \
    -gltsym 'SYM: +2*MST_rep[5..6]'                    \
    -glt_label 2 'MST_rep'                    \
    -gltsym 'SYM: +3*MST_lure[5..6]'                   \
    ...
    -bucket stats.MST.sub-alena                                     \
    -iresp 1 MST_novel.resp                                     \
    -iresp 2 MST_rep.resp                                       \
    -iresp 3 MST_lure.resp                                        \
    #-sresp 1 novel_smaller.sresp                                    \
    #-sresp 2 novel_larger.sresp                                     \
    #-sresp 3 rep_smaller.sresp                                      \
