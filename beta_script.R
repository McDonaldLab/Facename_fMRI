...
results <- "~/research_bin/r01/BIDS/derivatives/fmriprep/sub-alena/stat_results"
...
right_CA3_ttest_results <- t.test(r_CA3_novel$V1, r_CA3_repeated$V1, paired = TRUE, alternative = "two.sided")
...
fileName <- paste0("sub-alena_r_dentate_results.jpg")

fileName <- paste0("sub-alena_r_CA3_resluts.jpg")  
fileName <- paste0("sub-alena_r_whole_hipp_results.jpg")  
fileName <- paste0("sub-alena_r_caudate_results.jpg")
fileName <- paste0("sub-alena_r_precentral_gyrus_results.jpg")
